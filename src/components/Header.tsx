      ...
      <header className="header">
        <div className="container">
          <div className="header__wrapper">
            ...
            <nav className={openMenu ? "header__nav header__nav--active" : "header__nav"} onClick={() => setOpenMenu(false)}>
              ...
              <ul className="header__nav-list">
                ...
                <li className="header__nav-item">
                  <a className="header__nav-link header__nav-link--accent" href="#">
                    <img src={calc} alt="" />
            ...
            <div className="header__face">
              <div className="header__face-bar">
                ...
                <div className="header__face-item header__face-item-black header__face-item-mob" onClick={() => handleMobMenu()}>
                  <div className={openMenu ? "header__face-item-mob-menu header__face-item-mob-menu--active" : "header__face-item-mob-menu"}>
                    <span></span>
                  </div>
                </div>
              </div>
