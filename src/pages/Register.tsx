            ...
            <div className="register__box">
              ...
              <div className="register__box-grid">
                <div className="aside-popup__form-item register__box-item">
                  ...
                  ></input>
                  <label className="aside-popup__label" htmlFor="form-surname">
                    Прізвище<span>*</span>
                  </label>
                </div>
                <div className="aside-popup__form-item register__box-item">
                ...
                <div className="aside-popup__form-item register__box-item">
                  <input
                    ...
                    placeholder="Email"
                  ></input>
                  <label className="aside-popup__label" htmlFor="form-regemail">
                    Email<span>*</span>
                  </label>
                </div>
                <div className="aside-popup__form-item register__box-item">
                  ...
                  ></input>
                  <label className="aside-popup__label" htmlFor="form-reemail">
