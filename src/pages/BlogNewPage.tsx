        ...
        <div className="blognew__wrapper">
          <div className="blognew__content">
            ...
            <p className="blognew__text">
              Кухня – це місце, де ми щодня збираємося всією сім’єю за спільними
              трапезами. Крім того, саме тут твориться справжня магія –
              приготування улюблених страв на сніданок, обід і вечерю. Тому
              інтер’єр кухні повинен бути продуманий до дрібниць і відповідати
              на два головних запити: відчуття затишку і практичність.
            </p>
            <p className="blognew__text">
              Сьогодні ми розповімо про те, на що звертати увагу, плануючи
              дизайн кухні, які відтінки і матеріали найкраще підходять для цієї
              кімнати і як облаштувати простір так, щоб зробити кухню серцем
              вашого будинку.
            </p>
            <h2 className="blognew__med-title">Варіанти планування кухні</h2>
            <h4 className="blognew__small-title">Пряма кухня</h4>
            <p className="blognew__text">
              Пряме планування кухні підходить для витягнутої просторої кімнати.
              При такому способі розташування меблів весь кухонний гарнітур
              встановлюється уздовж однієї найдовшої стіни, що повністю звільняє
              іншу частину кімнати для місця під обідній стіл.
            </p>
            <p className="blognew__text">
            ...
            <div className="blognew__box">
              <div className="blognew__box-text">
                ...
                <p className="blognew__text">
                  Кутовий або по-іншому Г-подібний тип планування підходить для
                  квадратної кухні і актуальний як для маленьких, так і для
                  просторих кімнат. Принцип планування тут зрозумілий з назви:
                  кухонний гарнітур розташовується уздовж однієї з найширших
                  стін і однієї з найбільш вузьких (наприклад, біля вікна).
                </p>
              </div>
              <img src={img3} alt="" />
            </div>
            <div className="blognew__box">
              <img src={img4} alt="" />
              <div className="blognew__box-text">
                <h4 className="blognew__small-title">Кухня з барною стійкою</h4>
                <p className="blognew__text">
            ...
            <p className="blognew__text">
              ...
              використовуються при оформленні кухні. Вибирайте колір оздоблення,
              який викликає у вас відчуття комфорту. По суті, для кухні
              підходять практично будь-які забарвлення, головне – правильно їх
              поєднувати і не переборщити з колірною палітрою.
            </p>
            <div className="blognew__advice">
              <p className="blognew__advice-text">
                <span className="blognew__advice-text--accent">Порада.</span> Не
                варто робити кімнату в одному відтінку, навіть якщо ви
                продумуєте
                <a className="blognew__advice-text--link" href="#">
                  дизайн маленької кухні
                </a>
                . Рекомендуємо підібрати 2-3 кольори, які б гармонійно
                поєднувалися між собою. Для цього можна використовувати колірне
                коло Іттена.
              </p>
            </div>
            <img
              ...
              <div className="blognew__pouns">
                {dataAsidePouns.map((item, idx) => (
                  <div className="blognew__poun" key={idx}>
                    <img className="blognew__poun-img" src={item.img} alt="" />
